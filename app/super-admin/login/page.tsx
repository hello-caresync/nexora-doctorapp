...
import { ArrowRight, Crown, Eye, EyeOff, KeyRound, Mail, ShieldCheck } from 'lucide-react';
...
export default function SuperAdminLoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-[#f8fafc] p-4 font-sans text-slate-800 select-none">
      ...
      <div className="pointer-events-none absolute -top-32 -left-32 h-96 w-96 rounded-full bg-amber-200/30 blur-3xl" />
      <div className="pointer-events-none absolute -right-32 -bottom-32 h-96 w-96 rounded-full bg-blue-200/30 blur-3xl" />

      <div className="relative z-10 w-full max-w-md space-y-6 overflow-hidden rounded-3xl border border-slate-200/90 bg-white p-8 shadow-xl">
        <div className="space-y-2 text-center">
          <div className="mb-1 inline-flex rounded-2xl border border-amber-200/80 bg-amber-50 p-3 text-amber-600 shadow-xs">
            <Crown className="h-7 w-7" />
          </div>
          <div>
            <div className="mb-1.5 inline-flex items-center gap-1.5 rounded-full border border-amber-200 bg-amber-100/80 px-2.5 py-0.5 font-mono text-[10px] font-bold text-amber-800">
              <ShieldCheck className="h-3 w-3 text-amber-600" />
              LEVEL 0 PLATFORM ROOT
            </div>
            <h1 className="text-2xl font-black tracking-tight text-slate-900">Super Admin Gateway</h1>
