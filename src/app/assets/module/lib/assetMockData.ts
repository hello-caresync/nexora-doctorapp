...
export const INITIAL_ASSET_REQUESTS: AssetRequest[] = [
  { id: 'AR-2026-441', department: 'ICU', itemDescription: 'Dr├ñger Evita V300 Ventilator ΓÇö surge capacity unit', priority: 'Emergency', stage: 'Manager Review', requester: 'Dr. Meera Iyer', estimatedCost: 2850000, submittedAt: '2026-07-18T07:30:00' },
  { id: 'AR-2026-438', department: 'Radiology', itemDescription: 'CT tube replacement kit ΓÇö GE Optima CT660', priority: 'Critical', stage: 'Finance', requester: 'Rad Tech Lead', estimatedCost: 4200000, submittedAt: '2026-07-17T14:00:00' },
  ...
  { id: 'AR-2026-432', department: 'Emergency', itemDescription: 'Philips HeartStart defibrillator ΓÇö backup unit', priority: 'Critical', stage: 'Request', requester: 'ER Charge Nurse', estimatedCost: 385000, submittedAt: '2026-07-18T08:00:00' },
  { id: 'AR-2026-429', department: 'IT', itemDescription: 'PACS workstation refresh ΓÇö radiology reading room', priority: 'Normal', stage: 'Approved', requester: 'IT Infrastructure', estimatedCost: 620000, submittedAt: '2026-07-12T09:00:00' },
];

export const INITIAL_ASSET_LOCATIONS: AssetLocation[] = [
  { id: 'loc-1', assetTag: 'NX-AST-004821', assetName: 'GE Optima CT660', building: 'Main Block', floor: 'Ground', department: 'Radiology', room: 'CT Suite B', bedLocation: 'ΓÇö', status: 'Active', lastMovedAt: '2025-11-10' },
  { id: 'loc-2', assetTag: 'NX-AST-002156', assetName: 'Dr├ñger Evita V300', building: 'Critical Care Tower', floor: '3rd', department: 'ICU', room: 'ICU-3', bedLocation: 'Bed 4', status: 'Under Maintenance', lastMovedAt: '2026-07-17' },
  { id: 'loc-3', assetTag: 'NX-AST-003902', assetName: 'Philips Ingenia MRI 1.5T', building: 'Main Block', floor: 'Basement', department: 'Radiology', room: 'MRI Suite A', bedLocation: 'ΓÇö', status: 'Active', lastMovedAt: '2024-03-22' },
  ...
  { id: 'loc-6', assetTag: 'NX-AST-006220', assetName: 'Steris V-PRO Sterilizer', building: 'OT Block', floor: '1st', department: 'CSSD', room: 'Sterilization Bay 1', bedLocation: 'ΓÇö', status: 'Recall', lastMovedAt: '2026-06-01' },
];

export const INITIAL_ASSET_MASTER: AssetMasterRecord[] = [
  { id: 'am-1', assetTag: 'NX-AST-004821', name: 'GE Optima CT660', category: 'CT Scanner', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'QR-NX-004821', status: 'Active', department: 'Radiology', purchaseDate: '2022-08-15', netBookValue: 18500000, warrantyExpiry: '2027-08-14', amcVendor: 'GE Healthcare India', calibrationDue: '2026-09-15', complianceVerified: true },
  { id: 'am-2', assetTag: 'NX-AST-003902', name: 'Philips Ingenia MRI 1.5T', category: 'MRI', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'RFID-NX-003902', status: 'Active', department: 'Radiology', purchaseDate: '2021-03-22', netBookValue: 42000000, warrantyExpiry: '2026-03-21', amcVendor: 'Philips Healthcare', calibrationDue: '2026-08-01', complianceVerified: true },
  { id: 'am-3', assetTag: 'NX-AST-002156', name: 'Dr├ñger Evita V300', category: 'Ventilator', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'QR-NX-002156', status: 'Under Maintenance', department: 'ICU', purchaseDate: '2023-06-10', netBookValue: 2100000, warrantyExpiry: '2028-06-09', amcVendor: 'Dr├ñger India', calibrationDue: null, complianceVerified: true },
  { id: 'am-4', assetTag: 'NX-AST-005118', name: 'Mindray BeneVision N22', category: 'Patient Monitor', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'QR-NX-005118', status: 'Breakdown', department: 'Emergency', purchaseDate: '2024-01-08', netBookValue: 485000, warrantyExpiry: '2027-01-07', amcVendor: 'Mindray Medical', calibrationDue: '2026-07-25', complianceVerified: true },
  { id: 'am-5', assetTag: 'NX-AST-007331', name: 'Schiller AT-102 Plus ECG', category: 'ECG', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'QR-NX-007331', status: 'Active', department: 'Cardiology OPD', purchaseDate: '2023-11-20', netBookValue: 185000, warrantyExpiry: '2026-07-20', amcVendor: 'Schiller AG India', calibrationDue: '2026-07-22', complianceVerified: true },
  { id: 'am-6', assetTag: 'NX-AST-008902', name: 'Beckman Coulter AU680', category: 'Lab Analyzer', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'RFID-NX-008902', status: 'Active', department: 'Central Laboratory', purchaseDate: '2020-05-12', netBookValue: 6200000, warrantyExpiry: '2025-05-11', amcVendor: 'Beckman Coulter', calibrationDue: '2026-07-30', complianceVerified: true },
  { id: 'am-7', assetTag: 'NX-AST-001445', name: 'Dell PowerEdge R750 PACS Node', category: 'IT Asset', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'QR-NX-001445', status: 'Active', department: 'IT Infrastructure', purchaseDate: '2025-01-15', netBookValue: 890000, warrantyExpiry: '2028-01-14', amcVendor: 'Dell ProSupport', calibrationDue: null, complianceVerified: true },
  { id: 'am-8', assetTag: 'NX-AST-006220', name: 'Steris V-PRO Low Temp Sterilizer', category: 'Infrastructure', serialRef: '[Serial Mapping Log ΓÇö Masked]', qrRfidTag: 'QR-NX-006220', status: 'Recall', department: 'CSSD', purchaseDate: '2019-09-01', netBookValue: 3200000, warrantyExpiry: '2024-08-31', amcVendor: 'Steris Corporation', calibrationDue: null, complianceVerified: false },
];
...
export const PREVENTIVE_MAINTENANCE: PreventiveMaintenance[] = [
  ...
  { id: 'pm-4', assetTag: 'NX-AST-002156', assetName: 'Dr├ñger Evita V300', routine: 'Quarterly', lastCompleted: '2026-05-15', nextDue: '2026-08-15', assignedEngineer: 'Biomed Eng. Priya S.', status: 'Scheduled' },
];

export const INITIAL_BREAKDOWN_TICKETS: BreakdownTicket[] = [
  { id: 'BD-2026-088', assetTag: 'NX-AST-005118', assetName: 'Mindray BeneVision N22', reportedBy: 'ER Charge Nurse', issue: 'SpO2 module intermittent failure ΓÇö patient monitoring compromised', status: 'Assigned', downtimeHours: 6.5, assignedTo: 'Biomed Eng. Amit D.', openedAt: '2026-07-18T02:00:00' },
  { id: 'BD-2026-085', assetTag: 'NX-AST-006220', assetName: 'Steris V-PRO Sterilizer', reportedBy: 'CSSD Supervisor', issue: 'Manufacturer recall ΓÇö hydrogen peroxide cycle validation failure', status: 'In Repair', downtimeHours: 168, assignedTo: 'Steris FSE', openedAt: '2026-07-11T08:00:00' },
  { id: 'BD-2026-082', assetTag: 'NX-AST-002156', assetName: 'Dr├ñger Evita V300', reportedBy: 'ICU Charge', issue: 'Scheduled PM ΓÇö flow sensor calibration drift detected', status: 'In Repair', downtimeHours: 12, assignedTo: 'Dr├ñger Service', openedAt: '2026-07-17T06:00:00' },
];
...
export const SPARE_PARTS: SparePartRecord[] = [
  { id: 'sp-1', partCode: 'SP-DRG-FLOW-SNS', description: 'Dr├ñger Evita flow sensor assembly', linkedAsset: 'NX-AST-002156', stockQty: 2, reorderLevel: 3, lastIssued: '2026-06-10' },
...
export const DISPOSAL_RECORDS: DisposalRecord[] = [
  { id: 'disp-1', assetTag: 'NX-AST-000892', assetName: 'Legacy Siemens Somatom CT', reason: 'End-of-life ΓÇö radiation source decommissioning required', residualValue: 250000, workflowStatus: 'Finance Review', submittedAt: '2026-07-10' },
  { id: 'disp-2', assetTag: 'NX-AST-000445', assetName: 'Obsolete PACS workstation cluster', reason: 'Technology refresh ΓÇö HIPAA storage non-compliance', residualValue: 45000, workflowStatus: 'Pending', submittedAt: '2026-07-15' },
];

export const INITIAL_AI_INSIGHTS: AiAssetInsight[] = [
  { id: 'ai-1', category: 'Predictive Maintenance', message: 'Dr├ñger Evita V300 (NX-AST-002156) may require flow sensor servicing within 15 days based on 2,840 ventilation hours and drift trend analysis', severity: 'Warning', status: 'Active', generatedAt: '2026-07-18T08:00:00' },
  { id: 'ai-2', category: 'Utilization', message: 'GE Optima CT660 utilization at 94% capacity ΓÇö peak hours 09:00ΓÇô14:00; recommend slot optimization to reduce OPD imaging wait times', severity: 'Info', status: 'Active', generatedAt: '2026-07-18T07:30:00' },
  { id: 'ai-3', category: 'Capital Planning', message: 'Philips MRI warranty expires Mar 2026 ΓÇö capital replacement forecast Γé╣58M; lease vs buy analysis recommended Q4 FY26', severity: 'Warning', status: 'Active', generatedAt: '2026-07-17T16:00:00' },
  { id: 'ai-4', category: 'Compliance', message: '3 ECG/Monitor calibration certificates expiring within 7 days ΓÇö regulatory audit risk flagged for Cardiology & Emergency', severity: 'Critical', status: 'Active', generatedAt: '2026-07-18T06:00:00' },
];
...
export function formatInrCr(amount: number): string {
  if (amount >= 10000000) return `Γé╣${(amount / 10000000).toFixed(1)} Cr`;
  if (amount >= 100000) return `Γé╣${(amount / 100000).toFixed(1)} L`;
