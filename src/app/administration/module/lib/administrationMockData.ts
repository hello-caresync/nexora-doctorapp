...
export const OPERATIONAL_STREAM: OperationalLogEntry[] = [
  { id: 'op-1', timestamp: '2026-07-18T09:05:00', category: 'Patient Flow', message: 'ER trauma activation ΓÇö 2 admissions routed to ICU step-down review', department: 'Emergency', severity: 'Critical' },
  { id: 'op-2', timestamp: '2026-07-18T08:58:00', category: 'Bottleneck', message: 'Laboratory TAT breach ΓÇö 28 critical reports exceeding 6hr SLA', department: 'Laboratory', severity: 'Warning' },
  { id: 'op-3', timestamp: '2026-07-18T08:45:00', category: 'Staff Activity', message: 'ICU nursing overtime threshold exceeded ΓÇö 3 staff on extended shift', department: 'ICU', severity: 'Warning' },
  { id: 'op-4', timestamp: '2026-07-18T08:30:00', category: 'Patient Flow', message: 'OPD peak queue ΓÇö Cardiology wait time 42 min avg', department: 'OPD', severity: 'Warning' },
  { id: 'op-5', timestamp: '2026-07-18T08:15:00', category: 'Finance', message: 'Billing desk ΓÇö 14 pending discount approvals blocking discharge', department: 'Billing', severity: 'Normal' },
  { id: 'op-6', timestamp: '2026-07-18T08:00:00', category: 'Staff Activity', message: 'Morning shift handover completed ΓÇö all departments acknowledged', department: 'Administration', severity: 'Normal' },
];

export const INITIAL_APPROVALS: PendingApproval[] = [
  { id: 'ap-1', type: 'Leave Request', requester: 'Nurse Kavita Joshi', summary: 'Annual leave 5 days ΓÇö Ward C coverage arranged', department: 'Nursing', status: 'Pending', submittedAt: '2026-07-18T07:00:00' },
  { id: 'ap-2', type: 'Discount Approval', requester: 'Billing Desk', summary: 'Senior citizen concession ΓÇö IPD consolidated bill', department: 'Billing', status: 'Under Review', submittedAt: '2026-07-17T16:00:00' },
  { id: 'ap-3', type: 'Policy Exception', requester: 'OT Coordinator', summary: 'After-hours OT slot ΓÇö emergency CABG', department: 'OT', status: 'Pending', submittedAt: '2026-07-18T06:30:00' },
];
...
export const SHIFT_ROSTERS: ShiftRosterRow[] = [
  { id: 'sh-1', staffName: 'Dr. Meera Iyer', role: 'Emergency Physician', department: 'Emergency', shift: 'Morning 06:00ΓÇô14:00', coverage: 'Trauma ┬╖ Triage', status: 'Active' },
  { id: 'sh-2', staffName: 'Nurse Priya Nair', role: 'Charge Nurse', department: 'ICU', shift: 'Morning 06:00ΓÇô14:00', coverage: 'ICU 1ΓÇô4', status: 'Active' },
  { id: 'sh-3', staffName: 'Housekeeping Team C', role: 'Supervisor', department: 'Facilities', shift: 'Morning 07:00ΓÇô15:00', coverage: 'Wards AΓÇôC', status: 'Pending' },
];

export const COMPLAINTS: ComplaintRecord[] = [
  { id: 'cmp-1', source: 'Patient Feedback', category: 'Wait Time', summary: 'OPD Cardiology ΓÇö excessive wait despite appointment', status: 'Pending', assignedTo: 'OPD Manager', openedAt: '2026-07-17' },
  { id: 'cmp-2', source: 'Internal Staff', category: 'Facilities', summary: 'AC malfunction Ward B ΓÇö patient comfort impacted', status: 'In Progress', assignedTo: 'Facilities HOD', openedAt: '2026-07-16' },
  { id: 'cmp-3', source: 'TPA Escalation', category: 'Billing', summary: 'Pre-auth delay ΓÇö discharge blocked 48hrs', status: 'Open', assignedTo: 'Insurance Desk', openedAt: '2026-07-15' },
];

export const INITIAL_INCIDENTS: IncidentRecord[] = [
  { id: 'inc-1', type: 'Patient Fall', description: 'IPD Ward B Bed 14 ΓÇö assisted fall, no fracture, neuro checks ordered', rootCause: 'Pending investigation', status: 'Investigating', department: 'IPD', openedAt: '2026-07-18T02:00:00' },
  { id: 'inc-2', type: 'Equipment Failure', description: 'Steris V-PRO sterilizer ΓÇö cycle validation failure, CSSD quarantine', rootCause: 'Manufacturer recall batch', status: 'Root Cause Identified', department: 'CSSD', openedAt: '2026-07-11T08:00:00' },
  { id: 'inc-3', type: 'Medication Near-Miss', description: 'Wrong patient label on IV bag ΓÇö caught at bedside verification', rootCause: 'Barcode scanner offline', status: 'Open', department: 'Pharmacy', openedAt: '2026-07-18T06:00:00' },
];
...
export const COMPLIANCE_RENEWALS: ComplianceRenewal[] = [
  ...
  { id: 'cr-2', credential: 'Drug License ΓÇö Schedule H/X', regulatoryBody: 'CDSCO / State FDA', expiryDate: '2026-08-15', status: 'Pending' },
...
export const MEETING_LOGS: MeetingLog[] = [
  ...
  { id: 'mtg-3', title: 'Incident RCA ΓÇö Patient Fall Ward B', datetime: '2026-07-17T15:00:00', attendees: 'Nursing ┬╖ Risk ┬╖ Admin', status: 'Resolved' },
];

export const VENDOR_CONTRACT_ALERTS: VendorContractAlert[] = [
  { id: 'vc-1', vendor: 'GE Healthcare Service', contractType: 'AMC ΓÇö Imaging', expiryDate: '2026-12-31', status: 'Active' },
...
export const NABH_METRICS: NabhMetric[] = [
  { id: 'nm-1', parameter: 'Patient Identification Accuracy', target: 'ΓëÑ 99%', current: '99.2%', status: 'Active' },
  { id: 'nm-2', parameter: 'Hand Hygiene Compliance', target: 'ΓëÑ 85%', current: '82.4%', status: 'Pending' },
...
export const INITIAL_AI_INSIGHTS: AiAdminInsight[] = [
  { id: 'ai-1', query: "Show today's hospital issues", response: '3 open incidents ┬╖ 8 complaints ┬╖ Lab TAT breach (28 critical) ┬╖ ICU overtime ┬╖ Fire NOC expired ΓÇö immediate admin action required', category: 'Operations', severity: 'Critical', status: 'Active' },
  ...
  { id: 'ai-3', query: 'Staff shortage forecast ΓÇö next 7 days', response: 'ICU nursing ΓÇö 2 FTE gap ThuΓÇôSat ┬╖ Housekeeping Ward C ΓÇö understaffed ┬╖ Recommend float pool activation', category: 'Resource', severity: 'Warning', status: 'Active' },
  { id: 'ai-4', query: 'Patient load forecast', response: 'OPD expected +18% next week ΓÇö monsoon respiratory pattern ┬╖ ER surge probability elevated FriΓÇôSun', category: 'Resource', severity: 'Info', status: 'Active' },
];

export const AUDIT_ACTIVITY: AuditActivityEntry[] = [
  { id: 'au-1', timestamp: '2026-07-18T08:50:00', user: 'Dr. Admin Console', action: 'RBAC matrix update ΓÇö Quality Auditor role', module: 'Administration', result: 'Success' },
...
export const ORG_CONFIG_DETAILS: Record<OrgTreeNodeId, { title: string; rows: { label: string; value: string }[] }> = {
  ...
  'buildings-floors': {
    ...
    rows: [
      ...
      { label: 'Emergency Wing', value: 'Ground ΓÇö Trauma ┬╖ Triage' },
    ],
  },
  'departments-map': {
  ...
  'org-structure': {
    ...
    rows: [
      { label: 'Board ΓåÆ CEO', value: 'Medical Director ┬╖ COO ┬╖ CFO' },
      { label: 'Clinical Leadership', value: 'HODs ΓÇö Medicine ┬╖ Surgery ┬╖ Diagnostics' },
  ...
  'reporting-hierarchy': {
    ...
    rows: [
      { label: 'Clinical Escalation', value: 'Resident ΓåÆ HOD ΓåÆ Medical Director' },
      { label: 'Operational Escalation', value: 'Shift Lead ΓåÆ Dept Manager ΓåÆ COO' },
      { label: 'Incident Escalation', value: 'Unit ΓåÆ Risk Committee ΓåÆ CEO (Critical)' },
    ],
  },
  'employee-admin': {
    ...
    rows: [
      ...
      { label: 'Pending Onboarding', value: '12 ΓÇö background verification in progress' },
  ...
  'dept-working-hours': {
    ...
    rows: [
      { label: 'OPD Hours', value: 'MonΓÇôSat 08:00ΓÇô20:00 ┬╖ Sun 09:00ΓÇô14:00' },
      { label: 'IPD Nursing', value: '3-shift rotation ΓÇö 06:00 / 14:00 / 22:00' },
      { label: 'Emergency', value: '24├ù7 ┬╖ trauma team activation protocol' },
    ],
  },
  'dept-service-setup': {
    title: 'Service Setup & OPD Slots',
    rows: [
      { label: 'Cardiology OPD', value: '20 min slots ┬╖ 4 consultants ┬╖ peak 09:00ΓÇô12:00' },
      { label: 'General Medicine', value: '15 min slots ┬╖ walk-in + appointment' },
      { label: 'Teleconsult', value: 'Enabled ΓÇö video ┬╖ async messaging' },
    ],
  },
};
...
export function formatInrCr(amount: number): string {
  if (amount >= 10000000) return `Γé╣${(amount / 10000000).toFixed(2)} Cr`;
